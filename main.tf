...
module "logs" {
  source                   = "git::https://github.com/scream314/terraform-aws-s3-log-storage.git?ref=master"
...
module "dns" {
  source           = "git::https://github.com/scream314/terraform-aws-route53-alias.git?ref=master"
